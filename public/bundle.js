...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LayoutSignup = __webpack_require__(240);

	var _LayoutSignup2 = _interopRequireDefault(_LayoutSignup);

	var _LayoutLogin = __webpack_require__(241);

	var _LayoutLogin2 = _interopRequireDefault(_LayoutLogin);

	var _LayoutFindMyOrg = __webpack_require__(243);

	var _LayoutFindMyOrg2 = _interopRequireDefault(_LayoutFindMyOrg);

	var _Dashboard = __webpack_require__(244);

	var _Dashboard2 = _interopRequireDefault(_Dashboard);

	var _OrganizationListContainer = __webpack_require__(245);

	var _OrganizationListContainer2 = _interopRequireDefault(_OrganizationListContainer);
	...
	if (_config.ROOT_HOST == window.location.host) {
		(0, _reactDom.render)(_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(_reactRouter.Route, { path: '/', component: _LayoutFindMyOrg2.default }),
				_react2.default.createElement(_reactRouter.Route, { path: '/signup', component: _LayoutSignup2.default })
			)
		...
		(0, _reactDom.render)(_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_reactRouter.Route, { path: 'organization', component: _OrganizationListContainer2.default })
				),
				_react2.default.createElement(_reactRouter.Route, { path: '/login', component: _LayoutLogin2.default })
			)
		), document.getElementById('root'));
	}
													...
													_react2.default.createElement(
															...
															_react2.default.createElement(
																	...
																	_react2.default.createElement(
																			...
																			_react2.default.createElement(
																					'a',
																					{ className: 'dropdown-toggle', href: '#', 'data-toggle': 'dropdown', 'aria-haspopup': 'true', 'aria-expanded': 'true' },
																					_react2.default.createElement(
																							'span',
																			...
																			_react2.default.createElement(
																					...
																					_react2.default.createElement(
																							'li',
																							{ className: 'li_img' },
																							_react2.default.createElement('div', { className: 'imagecircle' }),
																							_react2.default.createElement(
																									'div',
																									{ className: 'user_title' },
																									'Aman Bansal'
																					...
																					_react2.default.createElement(
																							...
																							_react2.default.createElement(
																									'a',
																									{ href: '#', className: 'a_edit_my_detail' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LayoutSignup = function (_Component) {
	  _inherits(LayoutSignup, _Component);

	  function LayoutSignup() {
	    _classCallCheck(this, LayoutSignup);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LayoutSignup).call(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LayoutLogin = function (_Component) {
	  _inherits(LayoutLogin, _Component);

	  function LayoutLogin() {
	    _classCallCheck(this, LayoutLogin);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LayoutLogin).call(this));
	  ...
	  _createClass(LayoutLogin, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      axios.get(_config.API_URL_ORG_FINDBYDOMAIN, {
	        params: {
	        ...
	        // localStorage.setItem('id_token', response.data.token)
	        var org_id = response.data.org_id;
	        if (!org_id) {
	          window.location.href = _config.ROOT_URL;
	        }
...
/***/ function(module, exports) {
	...
	var ROOT_HOST = exports.ROOT_HOST = 'react.pma';
	var ROOT_URL = exports.ROOT_URL = 'http://react.pma';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LayoutFindMyOrg = function (_Component) {
	  _inherits(LayoutFindMyOrg, _Component);

	  function LayoutFindMyOrg() {
	    var _Object$getPrototypeO;

	    var _temp, _this, _ret;

	    _classCallCheck(this, LayoutFindMyOrg);

	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(LayoutFindMyOrg)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.handleSubmit = function (e) {
	      e.preventDefault();
	      // console.log(this.refs.email.value);
	      axios.post('http://local.pma/api/auth/signin', {
	        email: 'kamal@gmail.com',
	  ...
	  return LayoutFindMyOrg;
	}(_react.Component);

	exports.default = LayoutFindMyOrg;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _organizations = __webpack_require__(246);

	var _OrganizationList = __webpack_require__(269);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    fetchPosts: function fetchPosts() {
	      dispatch((0, _organizations.fetchPosts)()).then(function (response) {
	        !response.error ? dispatch((0, _organizations.fetchPostsSuccess)(response.payload)) : dispatch((0, _organizations.fetchPostsFailure)(response.payload));
	...
	var OrganizationListContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_OrganizationList2.default);

	exports.default = OrganizationListContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ROOT_URL = 'http://local.pma/api';
	function fetchPosts() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PagePanel = __webpack_require__(271);
	...
	var PostsList = function (_Component) {
	  ...
	  function PostsList() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(PostsList).apply(this, arguments));
	  }
	...
	var Sidebar = function (_Component) {
	  ...
	  _createClass(Sidebar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'container-fluid page-panel', id: '{this.props.id}' },
	        this.props.children
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_orgs = __webpack_require__(274);

	var _reducer_orgs2 = _interopRequireDefault(_reducer_orgs);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  posts: _reducer_orgs2.default });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    ...
	    case _organizations.FETCH_POSTS:
	      // start fetching posts and set loading = true
	      return _extends({}, state, { postsList: { posts: [], error: null, loading: true } });
	    case _organizations.FETCH_POSTS_SUCCESS:
	      // return list of posts and make loading = false
	      return _extends({}, state, { postsList: { posts: action.payload.data, error: null, loading: false } });
	    case _organizations.FETCH_POSTS_FAILURE:
	      // return error and make loading = false
	      error = action.payload.data || { message: action.payload.message }; //2nd one is network or server down errors
	      return _extends({}, state, { postsList: { posts: [], error: error, loading: false } });
	    case _organizations.RESET_POSTS:
	      // reset postList to initial state
	      return _extends({}, state, { postsList: { posts: [], error: null, loading: false } });
