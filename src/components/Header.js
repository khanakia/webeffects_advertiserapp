...
import {ROOT_URL, API_HOST_USERS_IMAGES, API_URL_USER_LOGO} from '../config.js'
									...
									<ul className="dropdown-menu userDetailsBox" aria-labelledby="dropdownMenu1">
										<li className="li_img">
											<div className="useravtarCt">
												<a className="user-avtar-link" href="javascript:void(0);" title="Change Avtar" onClick={(e)=> this.openPopuplogo(this.props.current_user, API_URL_USER_LOGO, e)}>
