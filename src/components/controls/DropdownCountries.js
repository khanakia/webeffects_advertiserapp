...
class DropdownCountries extends Component {
    ...
    componentDidMount() {
        CompanyHelper.index().then((response) => {
            ...
            jQuery(this.refs.dropdowncountries).val(this.props.defaultValue);
            jQuery(this.refs.dropdowncountries).selectpicker({
                size : 10,
                // actionBox : true,
                liveSearch : true
            });
    ...
    render() {
        ...
        return (
            <div className="control-dropdowncountries">
                <select className={ 'dropdowncountries' + this.props.className} ref="dropdowncountries" name={this.props.name} onChange={(e) => this.props.onChange(e)} >
                    ...
                    <option value="VG">Virgin Islands +1284</option>
