...
class ControlPrivacy extends Component {
    constructor(props) {
        super(props);
    }
...
const ControlPrivacyContainer = connectWithStore(ControlPrivacy, mapStateToProps, mapDispatchToProps)

export default ControlPrivacyContainer
