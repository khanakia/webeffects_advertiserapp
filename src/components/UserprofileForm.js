    ...
    static showInPoup() {
        ...
        Controls.showpopup({
            ...
            onopen : function(e){
              ...
              ReactDom.render(<UserprofileForm />, document.getElementById(uniq));
              console.log(pid);
              ...
              <div className="col-md-12">
                ...
                <div className="tab-content">
                    ...
                    <div className="row"><br/>
                      ...
                      <div className="col-md-8">  
                        <div className="form-group">
                          <input type="text" className="email form-control" value={this.state.data.email} />
                        </div>
                      </div>
                    </div>
                    <div className="row">
                  ...
                  <div role="tabpanel" className="tab-pane" id="details">
                    <div className="row"><br/>
                      <div className="col-md-3"><label>Job Title</label></div>
                      <div className="col-md-8">  
                        <div className="form-group">
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Office Phone</label></div>
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Cell Phone</label></div>
                      <div className="col-md-3">  
                        <div className="form-group">
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Home Phone</label></div>
                      <div className="col-md-8">  
                        <div className="form-group">
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Fax</label></div>
                      <div className="col-md-8">  
                        <div className="form-group">
                  ...
                  <div role="tabpanel" className="tab-pane" id="localization">
                    <div className="row"><br/>
                      <div className="col-md-3"><label>Language</label></div>
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Date Format</label></div>
                      <div className="col-md-6">  
                        <div className="form-group">
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Time Format</label></div>
                      <div className="col-md-6">  
                        <div className="form-group">
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Calendar Start</label></div>
                      <div className="col-md-6">  
                        <div className="form-group">
                    ...
                    <div className="row">
                      <div className="col-md-3"><label>Time Zone</label></div>
                      <div className="col-md-6">  
                        <div className="form-group">
